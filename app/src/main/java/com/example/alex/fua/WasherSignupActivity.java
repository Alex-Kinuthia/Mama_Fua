...
public class WasherSignupActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = WasherSignupActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_washer_signup);
    ...
    public void onClick(View v) {
        ...
        if (v == msignIn){
            Intent intent = new Intent(WasherSignupActivity.this, WasherLoginActivity.class);
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(WasherSignupActivity.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void createAuthStateListener() {
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    Intent intent = new Intent(WasherSignupActivity.this, WasherMapActivity.class);
